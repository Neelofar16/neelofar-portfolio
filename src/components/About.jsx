    ...
    <section className="mt-12 bg-white p-6 rounded-lg shadow">
      ...
      <div className="mt-4 grid md:grid-cols-3 gap-4">
        <div>
          ...
          <div className="mt-2 flex flex-wrap gap-2">
            <span className="px-2 py-1 bg-indigo-50 text-indigo-700 rounded">• Analytical Problem-Solving and Strategic Thinking</span>
            <span className="px-2 py-1 bg-indigo-50 text-indigo-700 rounded">• Collaborative Mindset and Leadership Potential </span>
            <span className="px-2 py-1 bg-indigo-50 text-indigo-700 rounded">• Clear & Confident Communication</span>
            <span className="px-2 py-1 bg-indigo-50 text-indigo-700 rounded">• Agility & Adaptability </span>
            <span className="px-2 py-1 bg-indigo-50 text-indigo-700 rounded">• Exceptional Time Management and Proactive Initiative</span>
          </div>
        </div>
        <div>
        ...
        <div>
          ...
          <p className="mt-2 text-gray-600">✓ 10th – 2011-12 to 2019-20                                                                                                                                                         
