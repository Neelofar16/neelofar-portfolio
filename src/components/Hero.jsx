    ...
    <header className="bg-gradient-to-r from-indigo-600 to-indigo-400 text-white py-20">
      <div className="max-w-5xl mx-auto px-6 flex flex-col md:flex-row items-center gap-8">
        <div className="flex-1">
          ...
          <p className="mt-4 text-lg text-indigo-100">AI/ML and Web Engineer | Eager to innovate learn and teach</p>
          <p className="mt-3 max-w-xl text-indigo-100/90">“AI Engineer & Researcher — developing production-ready ML systems, interactive dashboards, and published research to drive innovation in technology and society. I'm also ready to teach and mentor to support and help people to grow their skills.”</p>
          ...
          <div className="mt-6 flex gap-6 text-indigo-100">
            ...
            <div><strong className="text-white">5</strong><div className="text-sm">Internships</div></div>
            <div><strong className="text-white">10+</strong><div className="text-sm">Certifications</div></div>
          </div>
        </div>
        <div className="w-48 h-48 md:w-56 md:h-56 bg-white/20 rounded-full flex items-center justify-center border border-white/30">
          <img src="/assets/Photo.jpg" alt="Neelofar" className="w-40 h-40 rounded-full object-cover"/>
        </div>
      </div>
    </header>
  )
